...
if (isset($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM wishlist, product WHERE product.ProductID = wishlist.ProductID AND AccountID= $id";
                        ...
                        <table>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td class="cart__close" ><a href="delete.php?wishlistID=<?php echo $wishlistID;?>"><i class="fa fa-close"></i></a></td>
                                </tr>
                                <?php
                                }
                            }else {
