  ...
  <div class="wrapper ">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Manage Customer</p>
                  <h3 class="card-title"><a href="addtoCustomer.php"> New Customer</a></h3>
                </div>
                <div class="card-body">
            ...
            <td><a href="addtoCustomer.php?id=<?php echo $row['CustomerID']?>">Edit</a></td>
                        </tr>
                      </tbody>
                      <?php }
    } else {
    ...
    ?>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Ordersdetail Table</h4>
                  <p class="card-category"> Manage Ordersdetail</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
