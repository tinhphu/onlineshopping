...
?>
<h2>Add New Information FORM</h2>
<p><a href="ManageOrderCus.php">Back to User page</a></p>
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="hidden" id="AccountID" name="AccountID" value="<?php echo $AccountID?>" placeholder="">
    </div>
  </div>
